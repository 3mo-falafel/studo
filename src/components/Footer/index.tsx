...
const Footer = () => {
  ...
  return (
    <footer className="overflow-hidden">
        ...
        <div className="flex flex-wrap xl:flex-nowrap gap-10 xl:gap-19 xl:justify-between pt-17.5 xl:pt-22.5 pb-10 xl:pb-15">
          <div className="w-full">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-5">
              ...
              {/* Only Instagram kept as requested */}
              </div>
              {/* <!-- Social Links end --> */}
            </div>
          </div>
      ...
      <div className="py-3 bg-blue/5">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <p className="text-center text-dark">
            If you want to contact the developer: 
            <a href="https://facebook.com/jibreel.e.bornat" target="_blank" rel="noopener noreferrer" className="ml-2 underline hover:text-blue">Facebook</a>
            <span className="mx-2">•</span>
            <a href="https://wa.me/972599765211" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue">WhatsApp</a>
            <span className="mx-2">•</span>
            <a href="mailto:jibreelebornat@gmail.com" className="underline hover:text-blue">Email</a>
          </p>
        </div>
      </div>
        ...
        <div className="max-w-[1170px] mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex gap-5 flex-wrap items-center justify-center">
            <p className="text-dark font-medium text-center">
              All rights reserved by <span className="font-semibold">studo.ps</span> — owned and developed by <span className="font-semibold">Jibreel Bornat</span>.
            </p>
