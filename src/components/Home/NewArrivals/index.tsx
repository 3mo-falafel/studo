...
const NewArrival = () => {
  const { products, loading, error } = useProducts({ recentlyAdded: true, limit: 8 });

  if (loading) {
    return (
      <section id="new-arrivals" className="overflow-hidden pt-15 scroll-mt-28">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          ...
          <div className="text-center py-8">
            ...
            <p className="mt-2 text-gray-600">Loading new arrivals...</p>
          </div>
        </div>
      </section>
    );
